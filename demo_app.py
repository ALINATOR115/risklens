...
RAW_TRANSACTIONS_PATH = Path("data/raw/synthetic_transactions.csv")
SCORED_OUTPUT_PATH = Path("outputs/final_risk_scores.csv")
MERGED_OUTPUT_PATH = Path("outputs/product_evaluation_merged.csv")
